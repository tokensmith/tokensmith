...
public class ValidateOpenIdCodeResponseType {
    ...
    @Autowired
    public ValidateOpenIdCodeResponseType(OpenIdAuthRequestFactory openIdAuthRequestFactory, CompareConfidentialClientToOpenIdAuthRequest compareConfidentialClientToOpenIdAuthRequest) {
