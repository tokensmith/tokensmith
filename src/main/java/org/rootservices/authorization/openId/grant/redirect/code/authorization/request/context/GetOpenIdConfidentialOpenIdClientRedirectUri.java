 ...
 */
@Component
public class GetOpenIdConfidentialOpenIdClientRedirectUri extends GetOpenIdClientRedirectUri {

    private ConfidentialClientRepository confidentialClientRepository;

    @Autowired
    public GetOpenIdConfidentialOpenIdClientRedirectUri(ConfidentialClientRepository confidentialClientRepository) {
