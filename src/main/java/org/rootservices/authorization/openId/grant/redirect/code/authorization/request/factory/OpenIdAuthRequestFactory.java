...
import org.rootservices.authorization.openId.grant.redirect.code.authorization.request.context.GetOpenIdConfidentialOpenIdClientRedirectUri;
import org.rootservices.authorization.openId.grant.redirect.code.authorization.request.factory.required.OpenIdRedirectUriFactory;
...
public class OpenIdAuthRequestFactory {
    ...
    private GetOpenIdConfidentialOpenIdClientRedirectUri getOpenIdConfidentialClientRedirectUri;

    @Autowired
    public OpenIdAuthRequestFactory(ClientIdFactory clientIdFactory, OpenIdRedirectUriFactory openIdRedirectUriFactory, ResponseTypesFactory responseTypesFactory, ScopesFactory scopesFactory, StateFactory stateFactory, GetOpenIdConfidentialOpenIdClientRedirectUri getOpenIdConfidentialClientRedirectUri) {
