...
public enum ErrorCode {
    ...
    REDIRECT_URI_EMPTY_LIST (14, "redirect uris is a empty list"),
    REDIRECT_URI_NULL (15, "redirect uris is null"),

    // client or resource owner -- needs feedback from db.
    SCOPES_EMPTY_VALUE (16, "scopes first item is a empty value."),
    SCOPES_MORE_THAN_ONE_ITEM (17, "scopes has more than one value."),
    SCOPES_DATA_TYPE (18, "scopes first item is not a supported scope"),
    SCOPES_NOT_SUPPORTED (19, "scope is not available for this client"),

    STATE_EMPTY_VALUE (20, "states first item is a empty value"),
    STATE_MORE_THAN_ONE_ITEM (21, "states has more than one value."),

    CLIENT_NOT_FOUND (22, "client was not found"),
    RESPONSE_TYPE_MISMATCH (23, "response type provided does not match client's response type."),
    REDIRECT_URI_MISMATCH (24, "redirect uri provided does not match client's."),
    RESPONSE_TYPE_NOT_CODE (25, "response type provided is not CODE"),
    ...
    REDIRECT_URI_INVALID (33, "redirect uri is invalid"),
