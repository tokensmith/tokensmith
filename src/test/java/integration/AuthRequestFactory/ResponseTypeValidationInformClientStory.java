...
public class ResponseTypeValidationInformClientStory extends JUnitStory {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new InformClientSteps(authRequestFactory, clientRepository));
    }
}
