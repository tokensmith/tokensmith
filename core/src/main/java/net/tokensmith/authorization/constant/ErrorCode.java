package net.tokensmith.authorization.constant;
...
public enum ErrorCode {
    ...
    RESPONSE_TYPE_MISMATCH (23, "response_type provided does not match client response type"),
    REDIRECT_URI_MISMATCH (24, "redirect_uri provided does not match client"),
