 ...
 */
@Component
public class AccessRequestRepo implements AccessRequestRepository {

    @Autowired
    private AccessRequestMapper accessRequestMapper;

    public AccessRequestRepo() {}

    public AccessRequestRepo(AccessRequestMapper accessRequestMapper) {
