 ...
 */
@Component
public class AccessRequestScopesRepo implements AccessRequestScopesRepository {

    private AccessRequestScopesMapper accessRequestScopesMapper;

    @Autowired
    public AccessRequestScopesRepo(AccessRequestScopesMapper accessRequestScopesMapper) {
