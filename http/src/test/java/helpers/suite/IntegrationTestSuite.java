...
import net.tokensmith.authorization.http.controller.authorization.AuthorizationResourceTest;
import net.tokensmith.authorization.http.controller.authorization.OAuth2CodeResourceTest;
import net.tokensmith.authorization.http.controller.authorization.OAuth2ImplicitResourceTest;
import net.tokensmith.authorization.http.controller.authorization.OpenIdCodeResourceTest;
import net.tokensmith.authorization.http.controller.authorization.OpenIdImplicitIdentityResourceTest;
...
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOAuth2CodeTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOAuth2PasswordTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOAuth2RefreshTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOAuth2TokenTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOpenIdCodeTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOpenIdPasswordTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOpenIdRefreshTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceOpenIdTokenAndIdTokenTest;
import net.tokensmith.authorization.http.controller.userInfo.UserInfoResourceTest;
